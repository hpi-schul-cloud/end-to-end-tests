    ...
    for (var i = 1; i <= names.length; i++) {
        ...
        if (email === e_mail) {
            let boxConsent = await driver.$(
                selectorNamesContainer + " > tr:nth-child(" + i + ") > td:nth-child(7) > a:nth-child(2) > i"
            )
