...
Feature: Administrate pupils, classes and teachers
	...
	Scenario Outline: user edits a student
		...
		And admin clicks edit student Cancel button
		Then admin clicks edit student Cancel button inside popup
		And admin clicks edit student Cancel button
		And admin clicks edit student Discard-change button inside popup
