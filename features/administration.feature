...
Feature: Administrate pupils, classes and teachers
	...
	Scenario Outline: Admin creates a pupil
		...
		When admin set student firstname '<firstName>', lastname '<lastName>', email '<studentEmail>'
		...
		Examples:
			| firstName | lastName   | studentEmail              | adminsUsername        | adminPassword   | newPasswordStudent |
