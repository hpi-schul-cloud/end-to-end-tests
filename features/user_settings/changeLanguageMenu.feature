...
Feature: Test set for user settings
    ...
    Scenario Outline: As a user, I want to be able to change the language
        ...
        Examples:
            ...
            | student  | ole.bart.qa@schul-cloud.org       | Schulcloud1qa! | Englisch | DASHBOARD,COURSES,TEAMS,CURRENT TASKS,ALL TASKS,MY FILES,NEWS,CALENDAR,LEARNING STORE,ADD-ONS,HELP SECTION                                 |
            ...
            | teacher  | dmitri.teacher.qa@schul-cloud.org | Schulcloud1qa! | Spanisch | PANEL,CURSOS,EQUIPOS,TAREAS ACTUALES,TODAS TAREAS,MIS ARCHIVOS,NOTICIAS,CALENDARIO,LERN-STORE,COMPLEMENTOS,ADMINISTRACIÓN,SECCIÓN DE AYUDA |
            | student  | ole.bart.qa@schul-cloud.org       | Schulcloud1qa! | Spanisch | PANEL,CURSOS,EQUIPOS,TAREAS ACTUALES,TODAS TAREAS,MIS ARCHIVOS,NOTICIAS,CALENDARIO,LERN-STORE,COMPLEMENTOS,SECCIÓN DE AYUDA                |
