...
Feature: Test set for user settings
    ...
    Scenario Outline: As a user, I want to be able to change the language
        ...
        Examples:
            ...
            | admin    | olivier.admin.qa@schul-cloud.org  | Schulcloud1qa! | Englisch | DASHBOARD,COURSES,TEAMS,TASKS,MY FILES,NEWS,CALENDAR,LEARNING STORE,ADD-ONS,HELP DESK,MANAGEMENT,HELP SECTION |
