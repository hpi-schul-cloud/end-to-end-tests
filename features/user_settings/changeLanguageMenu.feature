...
Feature: Test set for user settings
    ...
    Scenario Outline: As a user, I want to be able to change the language
        ...
        Examples:
            ...
            | admin    | olivier.admin.qa@schul-cloud.org  | Schulcloud1qa! | Spanisch  | PANEL,CURSOS,EQUIPOS,TAREAS,MIS ARCHIVOS,NOTICIAS,CALENDARIO,LERN-STORE,COMPLEMENTOS,ADMINISTRACIÓN,SECCIÓN DE AYUDA           |
