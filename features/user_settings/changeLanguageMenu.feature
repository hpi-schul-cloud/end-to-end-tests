...
Feature: Test set for user settings
    ...
    Scenario Outline: As a user, I want to be able to change the language
        ...
        Examples:
            ...
            | student  | ole.bart.qa@schul-cloud.org       | Schulcloud1qa! | Englisch | DASHBOARD,COURSES,TEAMS,ALL TASKS,MY FILES,NEWS,CALENDAR,LEARNING STORE,ADD-ONS,HELP SECTION                               |
            ...
            | student  | ole.bart.qa@schul-cloud.org       | Schulcloud1qa! | Spanisch | PANEL,CURSOS,EQUIPOS,TODAS TAREAS,MIS ARCHIVOS,NOTICIAS,CALENDARIO,LERN-STORE,COMPLEMENTOS,SECCIÓN DE AYUDA                |
