...
Feature: Test set for user settings
    ...
    Scenario Outline: As a user, I want to be able to change the language
        ...
        Examples:
            ...
            | admin    | olivier.admin.qa@schul-cloud.org  | Schulcloud1qa! | Englisch | DASHBOARD,COURSES,TEAMS,MY FILES,NEWS,CALENDAR,LEARNING STORE,ADD-ONS,MANAGEMENT,HELP SECTION                        |
            ...
            | admin    | olivier.admin.qa@schul-cloud.org  | Schulcloud1qa! | Spanisch | PANEL,CURSOS,EQUIPOS,MIS ARCHIVOS,NOTICIAS,CALENDARIO,LERN-STORE,COMPLEMENTOS,ADMINISTRACIÓN,SECCIÓN DE AYUDA        |
            | teacher  | dmitri.teacher.qa@schul-cloud.org | Schulcloud1qa! | Spanisch | PANEL,CURSOS,EQUIPOS,TAREAS,MIS ARCHIVOS,NOTICIAS,CALENDARIO,LERN-STORE,COMPLEMENTOS,ADMINISTRACIÓN,SECCIÓN DE AYUDA |
            | student  | ole.bart.qa@schul-cloud.org       | Schulcloud1qa! | Spanisch | PANEL,CURSOS,EQUIPOS,TAREAS,MIS ARCHIVOS,NOTICIAS,CALENDARIO,LERN-STORE,COMPLEMENTOS,SECCIÓN DE AYUDA                |
